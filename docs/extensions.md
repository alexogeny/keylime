...
- `KEYLIME_CHECKPOINT_MESSAGES=semantic|metadata-only|deterministic` controls whether bounded redacted diff excerpts, metadata only, or no provider request is used,
