...
- `git-checkpoint.ts` — rollback checkpoints, `/undo`, explicitly gated Git commit identity setup, and confirmed non-interactive `/git-push` using Git remote credentials.
