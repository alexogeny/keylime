...
- `git-checkpoint.ts` — rollback checkpoints, `/undo`, guided `/git-auth`, explicitly gated Git commit identity setup, and confirmed non-interactive `/git-push` using Git remote credentials.
